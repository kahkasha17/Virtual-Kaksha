...
<body>
   ...
   <label for="option-2" class="option option-2 rad">
     <div class="dot" onclick="window.location='std_regis.jsp'" ></div>
      <span>Student</span>
   </label>
</div>
        ...
        <div class="heading" style="margin-top:1%">
            <h1 class="header-content">Teacher Registration Form</h1>
        </div>
         <!---------------------------------[ from ]--------------------------------->
        <div class="formbox" style="margin-bottom :1%">
            <div class="form">
                <form action="SignupActionTeach" method="post">
                    <div class="form-fields">
                        <div class="inputs">
                            <span><i class='bx bxs-user'></i></span><input type="text"title="Enter only Alhabets" pattern="[A-Za-z\s]{3,}" name="fname" id="fid" placeholder="Enter First Name" class="bottomborder" required>
                         </div>
                         <div class="inputs">
                            <span><i class='bx bxs-user'></i></span><input type="text"title="Enter only Alhabets" pattern="[A-Za-z\s]{3,}" name="lname" id="lid" placeholder="Enter Last Name" class="bottomborder" >
                        </div>
                        <div class="inputs">
                            <span><i class='bx bxs-key'></i></span><input type="password" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters" name="mypass" id="pass" placeholder="Enter password" class="bottomborder" required>
                        </div>
                        <div class="inputs">
                            <span><i class='bx bxl-gmail'></i></span><input type="email"pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$" name="mymail" id="mail" placeholder="abc123@gmail.com" class="bottomborder" required>
                        </div>
                        <div class="inputs">
                            <script>
                                function check()
                            ...
                            <span><i class='bx bx-mobile'></i></span><input type="number" name="mymob" id="mob" placeholder="9211420420" class="bottomborder" oninput="check()" required>
                        </div>
                        <div class="inputs">
                        ...
                        <div class="inputs">
                            <span><i class='bx bxs-book'></i></span><select name="mycourse" id="course" class="bottomborder extrawidth" required>
            ...
            <div class="pic">
                <img src="images/signup.jpg" alt="SIGN-UP picture" width="100%" height="100%">
            </div>
        </div>
